...
const formSchema = z.object({
  label: z.string().min(1, "L'étiquette doit contenir au moins 1 caractères."),
...
export const BillboardForm: React.FC<BillboardFormProps> = ({
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error(
        "Assurez vous d'avoir retirer toutes les catégories utilisant cette bannière d'abord."
      );
    } finally {
      setLoading(false);
      setOpen(false);
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder="Étiquette de la bannière"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
